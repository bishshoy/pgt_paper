...
ResNet-18}
\begin{figure}[h] \centering \includegraphics[width=0.55\textwidth]{baseline-w_norm}
...
\newpage \subsection{Norm plots of weights (PGT) of non-BN ResNet-18}
\begin{figure}[h] \centering \includegraphics[width=0.55\textwidth]{pgt-w_norm}
...
\newpage \subsection{Norm plots of weights (AGC + PGT) of non-BN ResNet-18}
\begin{figure}[h] \centering \includegraphics[width=0.55\textwidth]{agc_pgt-w_norm}
