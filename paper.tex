...
\vskip1pc \fbox{
\begin{tabular}{p{.4\textwidth}p{.5\textwidth}} \bf Altering Backward Pass Gradients
improves Convergence  \\
Bishshoy Das, Milton Mondal\\ Brejesh Lall, Shiv Dutt Joshi, Sumantra Dutta Roy \\[1pc]
...
backward graph and all other gradient vectors $\nabla_{W_i}(L)^{*}$ are computed as is.
Because of the early injection of the transformed gradients, all other gradient vectors
that are connected to the transformed gradient through the chain rule, gets subsequently
altered.
