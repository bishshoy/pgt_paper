...
\author{Bishshoy Das\inst{1}\orcidID{0000-0002-6525-4015}\and Milton Mondal\inst{1}\orcidID{xxxx-xxxx-xxxx-xxxx}\and Brejesh Lall\inst{3}\orcidID{xxxx-xxxx-xxxx-xxxx}\and Shiv Dutt Joshi\inst{3}\orcidID{xxxx-xxxx-xxxx-xxxx}\and Sumantra Dutta Roy\inst{3}\orcidID{xxxx-xxxx-xxxx-xxxx}}
...
\begin{proof} \begin{alignat}{2} &\ \ \frac{p_i^{\alpha }}{\sum
...
\begin{proof} \begin{equation} \frac{\partial}{\partial \alpha
...
\multirow{2}{*}{\textbf{Method}} & \textbf{PGT} & \textbf{\hspace{-0.65cm} Train}
